...
screen quick_menu():
    ...
    if quick_menu:
        ...
        vbox:
            ...
            imagebutton auto "gui/textbox/atras_%s.png" action Rollback()
            imagebutton auto "gui/textbox/saltar_%s.png" action Skip() alternate Skip(fast=True, confirm=True)
            imagebutton auto "gui/textbox/historial_%s.png" action ShowMenu('history')
            imagebutton auto "gui/textbox/auto_%s.png" action Preference("auto-forward", "toggle")
            imagebutton auto "gui/textbox/guardar_%s.png" action ShowMenu('save')
            imagebutton auto "gui/textbox/prefs_%s.png" action ShowMenu('preferences')
            imagebutton auto "gui/textbox/hideui_%s.png" action HideInterface()
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_comenzar_%s.png" xpos 474 ypos 797 action Start ()

            imagebutton auto "gui/mm_gallery_%s.png" xpos 80 ypos 689 action ShowMenu("galeria")
        ...
        imagebutton auto "gui/mm_cargar_%s.png" xpos 772 ypos 817 action ShowMenu ("load")


        imagebutton auto "gui/mm_opciones_%s.png" xpos 419 ypos 913 action ShowMenu ("preferences")
        ...
        imagebutton auto "gui/mm_acercade_%s.png" xpos 715 ypos 964 action ShowMenu ("about")
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/mm_salir_%s.png" xpos 62 ypos 906 action Quit(confirm=not main_menu)
